...
public final class H2DatabaseExceptionFactory {
     ...
     */
    public static R2dbcException convert(DbException e) {
        return convert(DbException.toSQLException(e));
    }

    /**
     * Convert {@link SQLException} to {@link R2dbcException}.
     */
    static R2dbcException convert(SQLException e) {
